...
system='xorg xorg-server-xwayland xwayland-satellite xdg-user-dirs connman cronie pipewire libjack-pipewire pamixer pavucontrol brightnessctl mako wireplumber wl-clipboard wofi'
terminals='foot'
...
misc='zathura zathura-pdf-mupdf mpv mpc mpd ncmpcpp yt-dlp xdg-desktop-portal xdg-desktop-portal-gnome xdg-desktop-portal-gtk'
...
niri='cliphist quickshell ddcutil brightnessctl niri wlsunset evolution-data-server polkit-kde-agent'
