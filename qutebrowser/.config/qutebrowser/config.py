...
c.fonts.tabs.selected = "8pt default family"
c.fonts.tabs.unselected = "8pt default family"
c.messages.timeout = 5000
c.new_instance_open_target = 'tab-bg-silent'
c.qt.chromium.low_end_device_mode = 'always'
c.scrolling.bar = 'always'
c.statusbar.padding = {'bottom': 5, 'top': 5, 'left': 0, 'right': 0}
c.tabs.indicator.width = 0
c.tabs.padding = {'top': 8, 'bottom': 8, 'left': 3, 'right': 3}
...
c.colors.completion.category.bg = c.colors.completion.odd.bg
